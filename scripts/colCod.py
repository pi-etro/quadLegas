...
# metodo para listar colegas de uma lista de codigos
def colCod(df_deferidas, df_nomeras, lista_cod, ad):

    # df das turmas consultadas
    df_turmas_ra = DataFrame({'turma':lista_cod})
